                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card" style="border-top:4px solid blue">
                            <div class="card-body">
                                <h4> Batchwise Report </h4>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                        <div class="card-body">
                                            <form method="POST" action="{{route('batchwise_report')}}" id="order_form">
                                                @csrf
                                                ...
                                                <table id="datatable" class="table table-bordered nowrap"
                                                    ...
                                                    @if (isset($orders))
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $order->property_address }}</td>
                                                            <td>{!! isset($order->completion_date) ? date("m/d/Y", strtotime($order->completion_date)) : NULL !!}</td>
                                                        </tr>
                                                        @endforeach
                                                    @endif
                                                    </tbody>
